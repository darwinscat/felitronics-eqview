...
namespace g  = felitronics::eqview::grid;
...
static felitronics::analysis::PlotMap mapOf (float width, double lo = 20.0, double hi = 28000.0)
{
...
static std::vector<std::pair<double, int>> ticksOf (const felitronics::analysis::PlotMap& pm)
{
