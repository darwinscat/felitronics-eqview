...
# Contributing to felitronics-eqview
...
**Why.** felitronics-eqview is AGPL-3.0-or-later and the copyright is held solely by its authors, Oleh
...
It takes away none of the freedoms the AGPL grants you. You may use felitronics-eqview, study it, modify
...
The felitronics-eqview and Darwin's Cat names and logos are trademarks and are *not* covered by the code
licence.
